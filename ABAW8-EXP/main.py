...
if __name__ == '__main__':
    ...
    parser.add_argument('-cpu', default=2, type=int, help='How many threads are allowed?')
    ...
    # 1.2. Paths
    # parser.add_argument('-dataset_path', default='/home/data/wyq/ABAW_VA/ABAW-test/ABAW-EXP/exp_dataset_test/Affwild2_processed', type=str,
    #                     help='The root directory of the preprocessed dataset.')  # /scratch/users/ntu/su012/dataset/mahnob
    parser.add_argument('-dataset_path', default='/home/data1/wyq/ABAW_VA/ABAW-test/ABAW-EXP/exp_dataset_test/Affwild2_processed', type=str,
                        help='The root directory of the preprocessed dataset.')  # /scratch/users/ntu/su012/dataset/mahnob 
    parser.add_argument('-model_load_path', default='/home/data1/czp/code/ABAW-test/ABAW-EXP', type=str,
                        help='The path to load the trained model, such as the backbone.')  # /scratch/users/ntu/su012/pretrained_model
    parser.add_argument('-model_save_path', default='/home/data1/czp/code/ABAW-test/ABAW-EXP/save_model2va', type=str,
                        help='The path to save the trained model ')  # /scratch/users/ntu/su012/trained_model
    parser.add_argument('-python_package_path', default='/home/data1/czp/code/ABAW-test/ABAW-EXP', type=str,
    ...
    parser.add_argument('-experiment_name', default="ABAW-exp-0313-4", help='The experiment name.')
    ...
    parser.add_argument('-train_emotion', default="arousal",
    ...
    parser.add_argument('-backbone_state_dict', default="res50_ir_0.874",
    ...
    parser.add_argument('-num_epochs', default=300, type=int, help='The total of epochs to run during training.')
    ...
    parser.add_argument('-hop_length', default=300, type=int, help='The step size or stride to move the window.')
