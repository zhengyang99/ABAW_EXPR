...
class ABAW2_VA_Arranger(object):
    ...
    def generate_partition_dict_for_cross_validation(partition_dict, fold):
        ...
        fold_0_trials = trials_of_train_set[slice(0, 50)]
        fold_1_trials = trials_of_train_set[slice(50, 100)]
        fold_2_trials = trials_of_train_set[slice(100, 150)]
        fold_3_trials = trials_of_train_set[slice(150, 200)]
        fold_4_trials = trials_of_train_set[slice(200, 246)]
        fold_5_trials = trials_of_original_validate_set
        ...
        new_partition_dict['Target_Set'] = partition_dict['Test_Set']
    ...
    def __getitem__(self, index):
        ...
        if self.mode != "test":
            if length < self.window_length:
                ...
                labels = self.load_data(path, indices, "label.npy") # shape:[300,2] indices:300
        ...
        return features, labels, trial, length, indices  # labels.shape:[300,2]
